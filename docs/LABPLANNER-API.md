...
**57 exported functions have no record** (`c6-sharables --undocumented` lists them), because the
...
**Two types: `function` (233) and `datum` (35).** A `datum` is an exported constant that carries a
