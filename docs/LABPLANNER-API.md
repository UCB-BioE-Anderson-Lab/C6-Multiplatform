...
299 records in `sharables/generated/`, one per exported function that carries a JSDoc comment,
...
**Two types: `function` (262) and `datum` (37).** A `datum` is an exported constant that carries a
