...
339 records in `sharables/generated/`, one per exported function that carries a JSDoc comment,
...
**Two types: `function` (289) and `datum` (50).** A `datum` is an exported constant that carries a
