...
**76 exported functions have no record** (`c6-sharables --undocumented` lists them), because the
...
**Two types: `function` (236) and `datum` (34).** A `datum` is an exported constant that carries a
