...
283 records in `sharables/generated/`, one per exported function that carries a JSDoc comment,
...
**Two types: `function` (244) and `datum` (39).** A `datum` is an exported constant that carries a
