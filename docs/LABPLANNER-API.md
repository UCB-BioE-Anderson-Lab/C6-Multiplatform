...
311 records in `sharables/generated/`, one per exported function that carries a JSDoc comment,
...
**Two types: `function` (263) and `datum` (48).** A `datum` is an exported constant that carries a
