...
271 records in `sharables/generated/`, one per exported function that carries a JSDoc comment,
...
**Two types: `function` (236) and `datum` (35).** A `datum` is an exported constant that carries a
